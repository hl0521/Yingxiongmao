...
public class OkHttpClientManager {
     ...
     * @return Response
     */
    private Response _postFileSync(String url, File[] files, String[] fileKeys, Param... params) throws IOException {
    ...
    private Response _postFileSync(String url, File file, String fileKey, Param... params) throws IOException {
     ...
     * @throws IOException
     */
    private void _postFileAsyn(String url, ResultCallback callback, File[] files, String[] fileKeys, Param... params) throws IOException {
        Request request = buildMultipartFormRequest(url, files, fileKeys, params);
        deliveryResult(callback, request);
    }
     ...
     * @throws IOException
     */
    private void _postFileAsyn(String url, ResultCallback callback, File file, String fileKey) throws IOException {
        Request request = buildMultipartFormRequest(url, new File[]{file}, new String[]{fileKey}, null);
        deliveryResult(callback, request);
    }
     ...
     * @throws IOException
     */
    private void _postFileAsyn(String url, ResultCallback callback, File file, String fileKey, Param... params) throws IOException {
        Request request = buildMultipartFormRequest(url, new File[]{file}, new String[]{fileKey}, params);
        deliveryResult(callback, request);
    }
     ...
     * @param callback
     */
    private void _downloadFileAsyn(final String url, final String destFileDir, final ResultCallback callback) {
        final Request request = new Request.Builder().url(url).build();
...
//                    int inSampleSize = ImageUtils.calculateInSampleSize(actualImageSize, imageViewSize);
                    ...
                    // 说明：上面的ImageUtils类需在自己实现，对图片进行相应的处理，此时暂且先不管，以后补充
                    // TODO: 2015/11/21 ImageUtils 需要自己实现，待补充！
...
//                    final Bitmap bm = BitmapFactory.decodeStream(is, null, ops);
    ...
    public static Response postFileSync(String url, File[] files, String[] fileKeys, Param... params) throws IOException {
    ...
    public static Response postFileSync(String url, File file, String fileKey, Param... params) throws IOException {
    ...
    public static void postFileAsyn(String url, ResultCallback callback, File[] files, String[] fileKeys, Param... params) throws IOException {
        getInstance()._postFileAsyn(url, callback, files, fileKeys, params);
    }


    public static void postFileAsyn(String url, ResultCallback callback, File file, String fileKey) throws IOException {
        getInstance()._postFileAsyn(url, callback, file, fileKey);
    }
    ...
    public static void downloadFileAsyn(String url, String destDir, ResultCallback callback) {
        getInstance()._downloadFileAsyn(url, destDir, callback);
    }
